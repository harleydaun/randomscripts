...
# --------------------------------------------------------------------------------------------
# Installs Ruby 2.5.3 using rbenv/ruby-build on the Raspberry Pi (Raspbian)
#
# Run from the web:
...
# Welcome message
echo -e "
This will install Ruby 2.5.3 using rbenv/ruby-build.
...
# Install Ruby 2.5.3, don't generate RDoc to save lots of time
CONFIGURE_OPTS="--disable-install-doc --enable-shared" rbenv install 2.5.3 --verbose

# Set Ruby 2.5.3 as the global default
rbenv global 2.5.3
